...
// 	'Buzz_319_Training': 50,  // use 170 for peristaltic pump?
// 	'Monkey_Test':300,
// 	"Human_1": 300,
// }

// get reward duration from parameter file
// added 2023/07/06 James Cavanaugh
var monkey_reward_dur = 50;
...
spawn(function*() {
    ...
    for (trial.current = 0; trial.current < max_trial; trial.current++) {
        ...
        if (trial.need2loadParameters == 1) {
            ...
            trial.rewardDuration = trial.RewardDuration;
...
// getting reward duration from param file
// JCC 20230706
        yield dispenseReward(trial.reward, subjectIsMonkey, trial.rewardDuration);
